...
#动物HFD血浆
mice <- read_excel("D:/Cycy1/R_Proj/Diet/diet_animal_R/差异分析结果/b31/b31CD_HFD_17W_protein_ttest_diff.xlsx")
...
# 保存图像，调整图形尺寸
ggsave(paste0(dirname, "/PLASMA_combined_pathways_plot.tiff"), combined_plot, dpi = 300, width = 12, height = 12)  # 减小图形尺寸
